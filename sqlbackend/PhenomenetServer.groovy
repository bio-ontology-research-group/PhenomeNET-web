...
def startServer() {
  ...
  context.addServlet(GroovyServlet, '/sql_searchPhenomenet2.groovy')
  context.addServlet(GroovyServlet, '/sql_searchByIDphenomenet2.groovy')
  context.addServlet(GroovyServlet, '/sql_getSimilarityphenomenet2.groovy')
  context.addServlet(GroovyServlet, '/sql_comparePhenotype.groovy')
