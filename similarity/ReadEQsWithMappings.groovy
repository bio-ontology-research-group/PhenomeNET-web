...
new File("phenoGeneCleanData_fish.txt").splitEachLine("\t") { line ->
  def e = line[7]
...
File newOntologyFile=new File("a-with-mappings.owl");
newOntologyFile=newOntologyFile.getAbsoluteFile();
manager.saveOntology(outont, IRI.create(newOntologyFile))
